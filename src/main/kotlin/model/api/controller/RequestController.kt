...
class RequestController(
    ...
    private val multicastReceiveSocket: DatagramSocket,
    ...
    init {
        if (multicastSupported) {
            generalSocket.joinGroup(multicastGroup, networkInterface)
        }
    }
    ...
    private fun recieve(): Message {
        ...
        val parsed = GameMessage.parseFrom(buffer.copyOf(packet.length))
